...
class SocialGraph:
    ...
    def add_friendship(self, user_id, friend_id):
        ...
        if user_id == friend_id:
            ...
            # Adds edge between user and friend
            self.friendships[user_id].add(friend_id)
            # Adds edge between friend and user
    ...
    def add_user(self, name):
        ...
        # Creates a new user with new id with a name
        self.users[self.last_id] = User(name)
        # Adds the new user to the friendships dict
    ...
    def populate_graph(self, num_users, avg_friendships):
        ...
        for i in range(num_users):  # num_users is an int, so we need to do the range of the int
            # creates a new user with the name set to i + 1 because 0 is key error
        ...
        # This is the number of total friendships after creating them
        goal_friendships = (num_users * avg_friendships)
        ...
        while num_friendships < goal_friendships:  # While current FSs is less than goal FSs
            ...
            # Grab current user randomly
            current_user = randint(1, total_users)
            # print('current_user', current_user)
            # Grand another user(friend) randomly
            current_friend = randint(1, total_users)
